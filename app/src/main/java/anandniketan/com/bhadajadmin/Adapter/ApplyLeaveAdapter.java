...
//    private int annousID;
    ...
    public ApplyLeaveAdapter(Context context, List<String> listDataHeader, HashMap<String, ArrayList<LeaveModel.FinalArray>> listDataChild, onDeleteWithId onDeleteWithIdref, OnUpdateRecord onUpdateRecordRef, String status, String updatestatus, String deletestatus) {
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        reason = convertView.findViewById(R.id.txt_approveby);
...
//        annousID = childData.get(childPosition).getPKAnnouncmentID();
        ...
        approvedays.setText(childData.get(childPosition).getApproveDays());
