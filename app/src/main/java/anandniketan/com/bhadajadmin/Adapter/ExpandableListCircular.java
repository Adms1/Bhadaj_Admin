...
public class ExpandableListCircular extends BaseExpandableListAdapter {

    private Context _context;
    private List<String> _listDataHeader;
    private HashMap<String, ArrayList<CircularModel.FinalArray>> listChildData;
    ...
    @Override
    public List<CircularModel.FinalArray> getChild(int groupPosition, int childPosititon) {
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        final List<CircularModel.FinalArray> childData = getChild(groupPosition, 0);
        ...
        annousID = childData.get(childPosition).getPKCircularID();
        ...
        txtPdfLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!TextUtils.isEmpty(childData.get(childPosition).getCircularPDF())) {
                    Intent browserIntent = new Intent(Intent.ACTION_VIEW);
                    browserIntent.setDataAndType(Uri.parse(AppConfiguration.LIVE_BASE_URL + childData.get(childPosition).getCircularPDF()), "application/pdf");
