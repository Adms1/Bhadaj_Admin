...
import anandniketan.com.bhadajadmin.Model.Account.FinalArrayDailyCollection;
...
public class ExpandbleListAdapterDailyCollection extends BaseExpandableListAdapter {
    ...
    private HashMap<String, ArrayList<FinalArrayDailyCollection>> _listDataChild;
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        ArrayList<FinalArrayDailyCollection> detail = getChild(groupPosition, 0);
        if (convertView == null) {
    ...
    @Override
    public ArrayList<FinalArrayDailyCollection> getChild(int groupPosition, int childPosititon) {
        return this._listDataChild.get(this._listDataHeader.get(groupPosition));
    }
