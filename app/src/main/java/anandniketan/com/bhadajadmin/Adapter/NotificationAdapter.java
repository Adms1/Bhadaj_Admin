...
//                }
    ...
    private void callBirthdaywish(int i) {
        ...
        Call<JsonObject> call = apiService.getBirthdaywish(PrefUtils.getInstance(context).getStringValue("StaffID", "0"), finalArrays.get(i).getType(), finalArrays.get(i).getId());
