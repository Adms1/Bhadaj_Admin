...
public class ExapndableInOutSummaryAdapter extends BaseExpandableListAdapter  {
    ...
    public ExapndableInOutSummaryAdapter(Context context, List<String> listDataHeader, HashMap<String, ArrayList<EmployeeInOutSummaryModel.FinalArray>> listDataChild) {
        ...
        public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
            ...
            final CustomCalendarView customCalendarView = (CustomCalendarView)convertView.findViewById(R.id.calendar_view);
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
            ...
            txt_teachername = (TextView) convertView.findViewById(R.id.teachername_txt);
            txt_dept = (TextView) convertView.findViewById(R.id.dept_txt);
