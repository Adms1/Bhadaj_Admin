...
import anandniketan.com.bhadajadmin.Adapter.SchoolCalendarAdapter;
 ...
 */
public class MISSchoolCalendar2Fragment extends Fragment {
...
//
//    }
    public static MISSchoolCalendar2Fragment newInstance(int page, List<MIStudentWiseCalendarModel.Datum> data) {
        MISSchoolCalendar2Fragment fragment = new MISSchoolCalendar2Fragment();
        Bundle args = new Bundle();
