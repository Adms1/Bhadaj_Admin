package anandniketan.com.bhadajadmin.Fragment.Fragment.Student;
...
import anandniketan.com.bhadajadmin.Adapter.PhotoAdapter;
import anandniketan.com.bhadajadmin.Adapter.Student.GalleryAdapter;
...
import anandniketan.com.bhadajadmin.Utility.PathUtil;
...
//                    imgArray.add("" + (i + 1) + "_image_" + PathUtil.getFile(getActivity(), Uri.parse(mArrayUri.get(i))).getName());
                ...
                imgArray.add(mArrayUri.get(i).substring(14));
            }
        }
