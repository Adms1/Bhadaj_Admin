...
import anandniketan.com.bhadajadmin.Adapter.ExpandableHrHeadAdapter;
import anandniketan.com.bhadajadmin.Model.HR.HrHeadModel;
import anandniketan.com.bhadajadmin.R;
import anandniketan.com.bhadajadmin.Utility.ApiHandler;
import anandniketan.com.bhadajadmin.Utility.Utils;
import anandniketan.com.bhadajadmin.databinding.FragmentHrHeadBinding;
import retrofit.RetrofitError;
import retrofit.client.Response;

public class HrHeadFragment extends Fragment implements DatePickerDialog.OnDateSetListener{

    private FragmentHrHeadBinding fragmentHrAdminBinding;
    ...
    private List<HrHeadModel.FinalArray> finalArrayInOut;
    private ExpandableHrHeadAdapter exapndableInOutSummaryAdapter;
    private List<String> listDataHeader;
    private HashMap<String, ArrayList<HrHeadModel.FinalArray>> listDataChild;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        fragmentHrAdminBinding = DataBindingUtil.inflate(inflater,R.layout.fragment_hr_head,container,false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        tvHeader.setText(R.string.hr_head);
    ...
    private void setListners() {
        ...
        fragmentHrAdminBinding.fromdateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                whichDateClicked = 1;
                datePickerDialog = DatePickerDialog.newInstance(HrHeadFragment.this, Year, Month, Day);
            ...
            public void success(HrHeadModel announcementModel, Response response) {
                ...
                if (announcementModel.getSuccess().equalsIgnoreCase("True")) {
                    ...
                    if (finalArrayInOut != null) {
                        ...
                        fillExpLV();
                        exapndableInOutSummaryAdapter = new ExpandableHrHeadAdapter(getActivity(), listDataHeader, listDataChild, viewstatus);
    ...
    public void fillExpLV() {
        ...
        listDataChild = new HashMap<String, ArrayList<HrHeadModel.FinalArray>>();
        for (int i = 0; i < finalArrayInOut.size(); i++) {
            ...
            ArrayList<HrHeadModel.FinalArray> row = new ArrayList<HrHeadModel.FinalArray>();
