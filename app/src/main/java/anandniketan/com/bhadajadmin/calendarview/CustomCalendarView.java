...
package anandniketan.com.bhadajadmin.calendarview;
...
public class CustomCalendarView extends LinearLayout {
    ...
    private static final String decorate = "dayOfMonthText";
    private static final String INTIME = "tv_intime";
    private static final String OUTTIME = "tv_outtime";

    private static final String DAY_OF_MONTH_TEXT_CONTAINER = "dayOfMonthTextContainer";
    ...
    private void setDaysInCalendar() {
        ...
        for (int i = 1; i < 43; i++) {
            ...
            dayOfMonthContainer.setVisibility(VISIBLE);
            if (null != getCustomTypeface()) {
            ...
            if (CalendarUtils.isSameMonth(calendar, startCalendar)) {
                ...
                if (!isOverflowDateVisible()) {
                    ...
                    dayOfMonthContainer.setVisibility(INVISIBLE);

                }else if (i >= 31 && ((float) monthEndIndex / 7.0f) >= 1) {
                    dayView.setVisibility(View.GONE);
                    dayOfMonthContainer.setVisibility(INVISIBLE);
    ...
    private DayView getDayOfMonthText(Calendar currentCalendar) {
        return (DayView) getView(decorate, currentCalendar);
    }
