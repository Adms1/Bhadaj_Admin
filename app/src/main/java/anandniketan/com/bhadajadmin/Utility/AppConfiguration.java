...
public class AppConfiguration {
    ...
    public static final String BASEURL = "http://192.168.1.19:8086/MobileApp_Service.asmx/";// use for office
//  public static final String BASEURL = "http://103.8.216.132/MobileApp_Service.asmx/"; // use for client

    //URL From Image
    public static final String BASEURL_IMAGES = "http://192.168.1.19:8086/skool360-Category-Images/Admin/";// use for office
//  public static final String BASEURL_IMAGES ="http://103.8.216.132/skool360-Category-Images/Admin/";// use for client

    //URL From Icons
    public static final String BASEURL_ICONS = "http://192.168.1.19:8086/skool360-Design-Icons/Admin/";// use for office
